...
class __declspec(dllexport) YMatrix {
   public:     
	  ...
	  inline void Reflect(const YPlane *plane);							// Obtain reflection matrix of this plane
      inline void Shadow(const YPlane *plane, const YVector *pLight);			// Obtain shadow matrix fron the plane and the point/direction of light
