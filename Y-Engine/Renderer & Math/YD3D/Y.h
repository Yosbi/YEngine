...
// Defines
//-----------------------------------------------------------------------
const int MAX_ID = 65535;  // Max word value
...
typedef enum YRENDERSTATE_TYPE 
{
	...
	RS_DEPTH_NONE,				// No read or write with depth buffer(disable depth buffer)
	...
	RS_STENCIL_FUNC_EQUAL,		// Stencil pass mode
	...
	RS_STENCIL_PASS_REPLACE,	// Stencil pass replace
...
typedef struct YLIGHT_TYPE 
{
	...
	float      fAttenuation012[3];  // Change of intensity over distance
} YLIGHT;
