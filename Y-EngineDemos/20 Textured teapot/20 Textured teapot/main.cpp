...
HRESULT ProgramTick(void) 
{
	...
	g_pDevice->DrawText(g_nFontID,30, 20, 0, 200, 0, "Y-Engine Demo: Textured Teapod with Jim Blinn specular");
...
HRESULT Render(float TimeElapsed)
{
	...
	return g_pDevice->MeshRender(g_Mesh, g_MeshSkin);
}
...
HRESULT BuildGeometry(void) 
{
	...
	g_pDevice->GetSkinManager()->AddTexture(g_MeshSkin, "Texture_by_FE_Caruso.jpg", false, 0.0f, NULL, 0);
