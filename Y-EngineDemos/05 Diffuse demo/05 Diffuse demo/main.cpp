...
HRESULT ProgramTick(void) 
{
	...
	g_pDevice->DrawText(g_nFontID, 30, 20, 0, 200, 0, "Y-Engine Demo: Diffuse light");
...
HRESULT Render(float TimeElapsed)
{
	...
	YCOLOR DiffuseLight;
	DiffuseLight.fR = 1.0f;DiffuseLight.fG = 1.0f;DiffuseLight.fB = 1.0f;DiffuseLight.fA = 1.0f;
...
{		
	 return g_pDevice->CreateFX("Diffuse.fx", "DiffuseTech", true, NULL);		
} 
...
{
	YCOLOR d = { 0.0f, 0.7f, 0.0f, 1.0f };
	YCOLOR c = { 0.0f, 0.7f, 0.0f, 1.0f };
