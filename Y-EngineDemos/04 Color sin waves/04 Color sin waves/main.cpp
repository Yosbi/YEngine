...
HRESULT ProgramTick(void) 
{
	...
	g_pDevice->DrawText(g_nFontID, 30, 20, 0, 200, 0, "Y-Engine Demo: Color Sin Waves Demo (gelatin)");
				...
				PVERTEX *verts, WORD *indices, int *nIndis, int *nVerts)
{
	...
	*nIndis = numTris * 3;
	...
	{}
	g_pDevice->GetVertexManager()->CreateStaticBuffer(VID_PS, s, *nVerts, *nIndis, verts, indices, &g_sMesh);
	delete [] verts;
	delete [] indices;
}
